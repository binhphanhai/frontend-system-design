  ...
  projectDetailSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        "project-detail/web-worker",
        "project-detail/service-worker",
        "project-detail/styled-component",
        "project-detail/ant-design",
        "project-detail/redux",
        "project-detail/redux-toolkit",
        "project-detail/react-router",
        "project-detail/recharts",
        "project-detail/single-spa",
        "project-detail/simple-interpreter",
      ],
    },
  ],
};
